  ...
  fr: {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: "Non. Depuis le 22 juillet 2026, n'importe quel annonceur peut acheter des placements ChatGPT en self-serve, mais ils s'affichent sous la réponse, étiquetés « sponsorisé » et visuellement séparés d'elle : la réponse, elle, reste organique, et une recherche indépendante sur plus d'un million de requêtes shopping a montré que le carrousel shopping est construit uniquement sur des résultats organiques, le payant étant ignoré. Diffusion actuelle : États-Unis, Royaume-Uni, Canada, Australie, Nouvelle-Zélande, Japon et Corée du Sud — pas la France — et uniquement pour les utilisateurs connectés majeurs des tiers Free et Go. Ce que ça change vraiment : être la recommandation reste gratuit, quand un clic sponsorisé coûte 3-5 $. Monitor coûte 9 €/mois, et il travaille sur la réponse organique.",
      },
    ],
