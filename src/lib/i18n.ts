...
export const homeCopy = {
  ...
  fr: {
    ...
    heroTitle: "Ta visibilité IA, corrigée pour toi.",
    ...
    positioningTitle: "Les autres outils te donnent un enieme dashboard. Citeable te dit quoi corriger - et ecrit les correctifs pour toi.",
    ...
    dashboardCardTitle: "Encore un dashboard",
...
export const auditCopy = {
  en: {
    ...
    secondaryBody: "The free report stops at your score, AI sentiment, Gemini recommendation status, and cited competitors. Monitor adds 3 concrete priorities and monthly Gemini tracking. Agent at €19/month remains the fastest path if you want it handled for you.",
  ...
  fr: {
    ...
    secondaryBody: "Le rapport gratuit s'arrête au score, au sentiment IA, au statut de recommandation Gemini et aux concurrents cités. Monitor ajoute 3 priorités concrètes et un suivi Gemini mensuel. L'Agent à 19 €/mois reste le chemin le plus rapide si tu veux qu'on s'en occupe pour toi.",
