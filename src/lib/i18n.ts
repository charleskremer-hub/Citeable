  ...
  en: {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: "No. Since 22 July 2026 ChatGPT placements are open to buy self-serve, but they sit below the answer, labelled “sponsored” and visually separated from it: the answer itself stays organic, and independent research on more than a million shopping queries found the shopping carousel is drawn from organic results only, with paid ads ignored. Current rollout: the US, the UK, Canada, Australia, New Zealand, Japan and South Korea — not France — and only for logged-in adults on the Free and Go tiers. What actually changes: being the recommendation the assistant names is still free, while a sponsored click costs $3-5. Monitor costs €9/month, and it works on the organic answer.",
      },
    ],
  ...
  fr: {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: "Non. Depuis le 22 juillet 2026, les placements ChatGPT sont ouverts à l'achat en self-serve, mais ils s'affichent sous la réponse, étiquetés « sponsorisé » et visuellement séparés d'elle : la réponse, elle, reste organique, et une recherche indépendante sur plus d'un million de requêtes shopping a montré que le carrousel shopping est construit uniquement sur des résultats organiques, le payant étant ignoré. Diffusion actuelle : États-Unis, Royaume-Uni, Canada, Australie, Nouvelle-Zélande, Japon et Corée du Sud — pas la France — et uniquement pour les utilisateurs connectés majeurs des tiers Free et Go. Ce que ça change vraiment : être la recommandation reste gratuit, quand un clic sponsorisé coûte 3-5 $. Monitor coûte 9 €/mois, et il travaille sur la réponse organique.",
      },
    ],
