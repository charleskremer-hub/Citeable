  ...
  en: {
    ...
    pricingTiers: [
      ...
      },
      {
        ...
        features: [`${PLAN_PROMISES.monitor_9eur.buyerQuestionCount} buying questions re-checked ${RECHECK_CADENCE.en.adverb}`, "Copy-paste fixes written from your real gaps", "3 files ready to paste so AI reads your best answers (FAQ schema, llms.txt, robots.txt)", "Alerts when your score or your rivals move"],
        cta: "Start Monitor",
        href: "monitor",
        plan: "monitor",
        highlight: false,
  ...
  fr: {
    ...
    pricingTiers: [
      ...
      },
      {
        ...
        features: [`${PLAN_PROMISES.monitor_9eur.buyerQuestionCount} questions d'achat re-vérifiées ${RECHECK_CADENCE.fr.adverb}`, "Correctifs à copier-coller écrits depuis tes vrais écarts", "3 fichiers prêts à coller pour que les IA lisent tes meilleures réponses (schéma FAQ, llms.txt, robots.txt)", "Alertes quand ton score ou tes rivaux bougent"],
