...
export const homeCopy = {
  en: {
    ...
    engineLadder: "Engine ladder: Free and Monitor use Gemini. Agent uses ChatGPT (gpt-4o-mini) today. Claude, Grok, and Mistral are available only when their keys are activated.",
    ...
    agentCardBody: "Each weekly batch starts with fresh ChatGPT (gpt-4o-mini) recommendation checks. Claude, Grok, and Mistral are not active until their keys are activated.",
    ...
    pricingTiers: [
      ...
      },
      {
        ...
        badge: "Treatment",
        features: ["Fresh ChatGPT (gpt-4o-mini) checks before each batch", "1–3 fixes drafted for you every week", "FAQ, Google Business, website, and page copy", "Third-party mention plan: directory, Reddit/Quora, listicle", "Claude/Grok/Mistral-ready when keys are activated"],
        cta: "Start Agent",
        href: "agent",
        plan: "geo_agent",
        highlight: false,
    ...
    faqAnswer: "No. Enter your business name, website, and email. Free and Monitor use Gemini today; Agent uses ChatGPT (gpt-4o-mini) today. Claude, Grok, and Mistral are not live promises yet; they are added only when their keys are activated.",
  ...
  fr: {
    ...
    engineLadder: "Moteurs utilisés : Gratuit et Monitor utilisent Gemini. Agent utilise ChatGPT (gpt-4o-mini) aujourd'hui. Claude, Grok et Mistral ne sont disponibles que lorsque leurs clés sont activées.",
    ...
    agentCardBody: "Chaque lot hebdomadaire commence par de nouvelles vérifications ChatGPT (gpt-4o-mini). Claude, Grok et Mistral ne sont pas actifs tant que leurs clés ne sont pas activées.",
    ...
    pricingTiers: [
      ...
      },
      {
        ...
        badge: "Traitement",
        features: ["Vérifications ChatGPT (gpt-4o-mini) fraîches avant chaque lot", "1 à 3 corrections rédigées pour toi chaque semaine", "FAQ, Google Business, site et contenu de page", "Plan de mentions tierces : annuaire, Reddit/Quora, article comparatif", "Claude/Grok/Mistral prêts quand les clés sont activées"],
        cta: "Démarrer Agent",
        href: "agent",
        plan: "geo_agent",
        highlight: false,
    ...
    faqAnswer: "Non. Entre ton nom d'entreprise, ton site et ton email. Gratuit et Monitor utilisent Gemini aujourd'hui ; Agent utilise ChatGPT (gpt-4o-mini) aujourd'hui. Claude, Grok et Mistral ne sont pas promis en direct : ils seront ajoutés seulement quand leurs clés seront activées.",
