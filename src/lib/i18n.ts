...
export const auditCopy = {
  en: {
    ...
    productEyebrow: "AI shopping · product-level",
    productTitle: "Your flagship product, seen by AI shopping cards",
    productSkuLabel: "Flagship product detected",
    productMarkupPresent: "Product markup present",
    productMarkupAbsent: "Product markup missing",
    productFixLabel: "Product JSON-LD fix — paste on the product page before </head>",
    productFixHint: "Price and currency are exactly what we read on your page — never invented. Edit availability if needed.",
  ...
  fr: {
    ...
    productEyebrow: "Shopping IA · niveau produit",
    productTitle: "Ton produit phare, vu par les cartes shopping IA",
    productSkuLabel: "Produit phare détecté",
    productMarkupPresent: "Balisage Product présent",
    productMarkupAbsent: "Balisage Product absent",
    productFixLabel: "Correctif JSON-LD Product — à coller sur la page produit avant </head>",
    productFixHint: "Le prix et la devise sont exactement ceux lus sur ta page — jamais inventés. Ajuste la disponibilité si besoin.",
