...
export const homeCopy = {
  en: {
    ...
    whyNowEyebrow: "Why this matters now",
    whyNowTitle: "Soon, AI won't just advise your customers — it will buy for them.",
    whyNowBody: "AI shopping agents already read product data and pick the best options themselves. If AI doesn't understand and recommend you, no ad budget wins the sale. The battle moved upstream of the click.",
  ...
  fr: {
    ...
    whyNowEyebrow: "Pourquoi c'est maintenant",
    whyNowTitle: "Bientôt, l'IA ne conseille plus tes clients — elle achète pour eux.",
    whyNowBody: "Les agents IA lisent déjà la donnée produit et choisissent eux-mêmes les meilleures options. Si l'IA ne te comprend pas et ne te recommande pas, aucun budget pub ne gagne la vente. La bataille se joue avant le clic.",
