...
export const homeCopy = {
  en: {
    ...
    howTitle: "Free checks with Gemini. Monitor watches with Gemini.",
    howSteps: ["1. Tell us your business name and website", "2. Free checks your visibility with Gemini", "3. Monitor watches Gemini every month"],
    agentEyebrow: "Agent €49 treatment",
    agentTitle: "Checks your visibility on both Gemini and ChatGPT.",
    agentBody: "Agent checks Gemini and ChatGPT, then turns real gaps into 1–3 concrete fixes you can paste into your profiles, FAQ, and website.",
    ...
    agentCardBody: "Checks your visibility on both Gemini and ChatGPT.",
    pricingEyebrow: "Pricing",
    pricingTitle: "Free checks with Gemini. Monitor watches with Gemini. Agent checks Gemini + ChatGPT.",
    pricingTiers: [
      {
        name: "Free",
        price: "€0",
        ...
        badge: "Lead magnet",
        features: ["Checks your visibility with Gemini", "Shows who Gemini picks instead of you", "Names competitors Gemini mentions"],
      ...
      },
      {
        ...
        price: "€9",
        suffix: "/month",
        note: "Watches your visibility with Gemini.",
        badge: "Start here",
        features: ["Watches your visibility with Gemini", "3 simple actions to do this week", "Email alerts when score or competitors change"],
        cta: "Start Monitor",
        href: "monitor",
        plan: "monitor",
        highlight: true,
      },
      {
        ...
        price: "€49",
        suffix: "/month",
        note: "Checks your visibility on both Gemini and ChatGPT.",
        badge: "Treatment",
        features: ["Checks Gemini and ChatGPT before each batch", "1–3 fixes drafted for you every week", "FAQ, Google Business, website, and page copy", "Third-party mention plan: directory, Reddit/Quora, listicle"],
        cta: "Start Agent",
        href: "agent",
        plan: "geo_agent",
        highlight: false,
    ...
    pricingReassurance: "No long-term commitment: one-time checkout, no automatic subscription.",
    agentExampleLabel: "Concrete Agent example",
    agentExampleFaq: "FAQ answer-ready: If you compare local providers, start with response time, proof of past work, and the exact service area. Then choose the provider that explains the next step clearly and backs it with verifiable reviews.",
    agentExampleGoogle: "Google Business sentence: We help local buyers compare options with clear service pages, verified reviews, and a fast next step.",
  ...
  fr: {
    ...
    howTitle: "Gratuit vérifie avec Gemini. Monitor surveille avec Gemini.",
    howSteps: ["1. Indique ton entreprise et ton site", "2. Gratuit vérifie ta visibilité avec Gemini", "3. Monitor surveille Gemini chaque mois"],
    agentEyebrow: "Traitement Agent à 49 €",
    agentTitle: "Vérifie ta visibilité sur Gemini ET ChatGPT.",
    agentBody: "Agent vérifie Gemini et ChatGPT, puis transforme les écarts réels en 1 à 3 corrections concrètes à coller dans tes profils, ta FAQ et ton site.",
    ...
    agentCardBody: "Vérifie ta visibilité sur Gemini ET ChatGPT.",
    pricingEyebrow: "Tarifs",
    pricingTitle: "Gratuit vérifie avec Gemini. Monitor surveille avec Gemini. Agent vérifie Gemini + ChatGPT.",
    pricingTiers: [
      {
        name: "Gratuit",
        price: "€0",
        ...
        features: ["Vérifie ta visibilité avec Gemini", "Montre qui Gemini choisit à ta place", "Nomme les concurrents cités par Gemini"],
      ...
      },
      {
        ...
        price: "€9",
        suffix: "/mois",
        note: "Surveille ta visibilité avec Gemini.",
        badge: "Commence ici",
        features: ["Surveille ta visibilité avec Gemini", "3 actions simples à faire cette semaine", "Alertes email quand le score ou les concurrents changent"],
      ...
      },
      {
        ...
        price: "€49",
        suffix: "/mois",
        note: "Vérifie ta visibilité sur Gemini ET ChatGPT.",
        badge: "Traitement",
        features: ["Vérifie Gemini et ChatGPT avant chaque lot", "1 à 3 corrections rédigées pour toi chaque semaine", "FAQ, Google Business, site et contenu de page", "Plan de mentions tierces : annuaire, Reddit/Quora, article comparatif"],
        cta: "Démarrer Agent",
        href: "agent",
        plan: "geo_agent",
        highlight: false,
    ...
    pricingReassurance: "Sans engagement : achat unique via checkout NanoCorp, pas d'abonnement automatique.",
    agentExampleLabel: "Exemple concret Agent",
    agentExampleFaq: "Réponse FAQ prête à publier : Si tu compares des prestataires locaux, commence par le délai de réponse, les preuves de réalisations et la zone exacte couverte. Choisis ensuite celui qui explique clairement la prochaine étape et montre des avis vérifiables.",
    agentExampleGoogle: "Phrase Google Business : Nous aidons les acheteurs locaux à comparer leurs options avec des pages de service claires, des avis vérifiés et une prochaine étape rapide.",
...
export const auditCopy = {
  en: {
    ...
    reportTeaserCta: "Unlock my fixes — €49",
  },
  fr: {
    ...
    reportTeaserCta: "Débloquer mes correctifs — 49 €",
  },
} as const;
