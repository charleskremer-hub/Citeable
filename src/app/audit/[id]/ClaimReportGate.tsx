...
export default function ClaimReportGate({ auditId, locale }: ClaimReportGateProps) {
  ...
  return (
    <section className="rounded-[1.5rem] border border-[#123E5C]/30 bg-[#123E5C]/[0.06] p-5 sm:p-6" data-testid="claim-report-gate">
      ...
      <form onSubmit={handleSubmit} className="mt-4 flex flex-col gap-2.5 sm:flex-row">
        ...
        <button
          ...
          className="whitespace-nowrap rounded-xl bg-[#123E5C] px-5 py-3 text-sm font-black text-white transition hover:brightness-110 disabled:opacity-60"
        >
